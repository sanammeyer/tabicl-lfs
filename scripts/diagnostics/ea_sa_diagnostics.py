...
Usage example:
  python scripts/diagnostics/ea_sa_diagnostics.py --dataset 23 \
      --sa_checkpoint checkpoints/mini_tabicl_stage2_sa/step-1000.ckpt \
      --ea_checkpoint checkpoints/mini_tabicl_stage2_ea/step-1000_ea.ckpt
"""
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument(
        "--sa_checkpoint",
        type=str,
        default=str(ROOT / "checkpoints" / "mini_tabicl_stage2_sa" / "step-1000.ckpt"),
        help="Stage-2 SA checkpoint path.",
    )
    ap.add_argument(
        "--ea_checkpoint",
        type=str,
        default=str(ROOT / "checkpoints" / "mini_tabicl_stage2_ea" / "step-1000_ea.ckpt"),
