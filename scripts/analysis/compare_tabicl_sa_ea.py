...
Defaults:
  ...
  - Uses mini-TabICL Stage-2 checkpoints at:
       checkpoints/mini_tabicl_stage2_sa/step-1000.ckpt
       checkpoints/mini_tabicl_stage2_ea_icl_only/step-1000.ckpt
...
--------------
  ...
  python scripts/analysis/compare_tabicl_sa_ea.py \\
      ...
      --ea_checkpoint checkpoints/mini_tabicl_stage2_ea_icl_only/step-1000.ckpt \\
      --datasets 3,11,15,23 \\
      --skip_geometry
"""
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument(
        "--ea_checkpoint",
        type=str,
        default=str(REPO_ROOT / "checkpoints" / "mini_tabicl_stage2_ea_icl_only" / "step-1000.ckpt"),
